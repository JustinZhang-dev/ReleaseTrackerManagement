...
/**
 * REST controller for managing {@link com.hackathon.domain.State}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class StateResource {
    ...
    private static final String ENTITY_NAME = "releaseManageState";
        ...
        Optional<State> result = stateRepository
            ...
            .map(existingState -> {
                if (state.getStateId() != null) {
                    existingState.setStateId(state.getStateId());
                }
                if (state.getState() != null) {
                    existingState.setState(state.getState());
                }
                if (state.getStateSeq() != null) {
                    existingState.setStateSeq(state.getStateSeq());
                }
