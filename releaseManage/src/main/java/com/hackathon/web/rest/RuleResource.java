...
/**
 * REST controller for managing {@link com.hackathon.domain.Rule}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RuleResource {
    ...
    private static final String ENTITY_NAME = "releaseManageRule";
        ...
        Optional<Rule> result = ruleRepository
            ...
            .map(existingRule -> {
                ...
                if (rule.getRuleGroup() != null) {
                    existingRule.setRuleGroup(rule.getRuleGroup());
                }
                if (rule.getRuleSeq() != null) {
                    existingRule.setRuleSeq(rule.getRuleSeq());
                }
                if (rule.getRuleState() != null) {
                    existingRule.setRuleState(rule.getRuleState());
                }
                if (rule.getRuleMap() != null) {
                    existingRule.setRuleMap(rule.getRuleMap());
                }
