...
import com.hackathon.domain.Notification;
...
/**
 * REST controller for managing {@link com.hackathon.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NotificationResource {
    ...
    private static final String ENTITY_NAME = "supportManageNotification";
    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                ...
                if (notification.getNotifySeq() != null) {
                    existingNotification.setNotifySeq(notification.getNotifySeq());
                }
                if (notification.getNotifyType() != null) {
                    existingNotification.setNotifyType(notification.getNotifyType());
                }
                if (notification.getNotifyTo() != null) {
                    existingNotification.setNotifyTo(notification.getNotifyTo());
                }
                if (notification.getNotifyBy() != null) {
                    existingNotification.setNotifyBy(notification.getNotifyBy());
                }
